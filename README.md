...
Сейчас очень нужна помощь с моделированием системы, почитать о котором можно [здесь](https://docs.djangoproject.com/en/1.11/intro/tutorial02/#craeting-models).
                                                                              [здесь1](https://docs.djangoproject.com/en/1.11/intro/tutorial02/#database-setup)
																				[здесь2](https://docs.djangoproject.com/en/1.11/intro/tutorial02/#creating-models)
### Как запускать
